        ...
        >
            ...
            <div className='w-full max-w-[360px] min-[769px]:block hidden'>
                ...
                <div className='text-[16px] max-w-full w-full'>
                    ...
                    <div onClick={handlePrivacyEntryClick} className='cursor-pointer flex items-center justify-between gap-0 px-4 py-3 rounded-[12px] hover:bg-[#E3E8EF] transition-all duration-200'>
                        <div className='flex items-center justify-center justify-start gap-4'>
                            <div className='w-[24px] h-[24px] min-w-[24px] min-h-[24px] max-w-[24px] max-h-[24px]'>
                    ...
                    <div onClick={handlePrivacyEntryClick} className='cursor-pointer flex items-center justify-between gap-0 px-4 py-3 rounded-[16px] hover:bg-[#E3E8EF] transition-all duration-200'>
                        <div className='flex items-center justify-center justify-start gap-4'>
                            <div className='w-[24px] h-[24px] min-w-[24px] min-h-[24px] max-w-[24px] max-h-[24px]'>
                            ...
                            <div onClick={handlePrivacyEntryClick} className='cursor-pointer flex items-center justify-between gap-0 px-4 py-3 rounded-[16px] hover:bg-[#E3E8EF] transition-all duration-200'>
                                <div className='flex items-center justify-between gap-3 pl-[24px] ml-3 w-full'>
                                    ...
                                    <div className='w-[24px] h-[24px] min-w-[24px] min-h-[24px] max-w-[24px] max-h-[24px] min-w-[24px] min-h-[24px]'>
                                        <img src="/images/icons/ic_opend.svg" className='w-full h-full' alt="" />
                                    </div>
                                </div>
                            </div>
                            <div onClick={handlePrivacyEntryClick} className='cursor-pointer flex items-center justify-between gap-0 px-4 py-3 rounded-[16px] hover:bg-[#E3E8EF] transition-all duration-200'>

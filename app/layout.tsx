...
import { optimisticFont, vietnameseFont } from '@/app/fonts';
...
export default function RootLayout(props: { children: React.ReactNode }) {
  ...
  const activeFontVariable = locale === 'vi' ? vietnameseFont.variable : optimisticFont.variable
  ...
  return (
    <html lang={htmlLang} data-theme={colorMode} style={{ colorScheme: colorMode }}>
      ...
      <body
        className={`chakra-ui-${colorMode} ${activeFontVariable} font-sans antialiased`}
      >
